        ...
        <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 50 }} transition={{ duration: 0.3 }}>
          <SheetContent>
            ...
            <SheetFooter className="flex flex-col flex-1 space-y-2">
              {/* <Button variant="outline" className="w-full h-15" onClick={handleSheetClose}>Cancel</Button> */}
              <Button type="submit" className="w-90 h-full">{editMode ? 'Save changes' : 'Add User'}</Button>
            </SheetFooter>
          </SheetContent>
        </motion.div>
      </Sheet>
